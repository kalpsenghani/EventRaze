                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="about-left">
                                <div class="about-top">
                                    <h1 class="section-title" style="text-align:justify; line-height:42px; color:blue"> <?php echo htmlentities($row->EventName);?> Details</h1>
    ...
    <h3>Sponser</h3>
                                <div class="total-step">
                                    <div class="about-step">
                                        <h5 class="sub-title"><?php echo htmlentities($row->sponserName);?></h5>
                                        <div class="descp">
 <p><img src="admin/sponsers/<?php echo htmlentities($row->sponserLogo);?>" width="170" style="border:solid 1px #000"></p>
                                        </div>
                                    </div>
                                </div>
                            </div>  
