         ...
         <?php include_once('includes/header.php');?>
                ...
                <div class="slider-container slider-02 bg-overlay">
                    ...
                    <div id="mainSlider" class="nivoSlider slider-image"> 
                        <img src="img/event-management-system.jpg" alt="event-management-system" title="#htmlcaption1" height="200" /> 
                    </div>
                        <div  class="nivoSlider slider-image"> 
                        <img src="img/ems.png" alt="event-management-system" title="#htmlcaption1" height="200" /> 
                    </div>
                </div>
                <!--slider area are End-->
    ...
    ?>
                              ...
                              <div class="single-upcomming shadow-box">
                                 <div class="col-md-4 hidden-sm col-xs-12">
                                     ...
                                     <div class="sue-date-time text-center" style="padding-left:5%;padding-top:15%;">
