...
<table border="2" class="table">
 <?php   $sql = "SELECT NewsTitle,NewsDetails,PostingDate from tblnews order by id desc ";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$cnt=1;
...
<td width="300"><?php echo htmlentities($row->NewsTitle);?></td> 
...
<?php $cnt++;
    ...
    <tr>
        <th colspan="5" style="color:red; text-align:center;">No Record found</th>
    </tr>
<?php } ?>
</table>
                                            </div>
