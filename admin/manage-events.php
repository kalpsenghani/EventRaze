...
<a href="manage-events.php?del=<?php echo htmlentities($row->eid);?>"  onclick="return confirm('Are you sure you want to delete?');"><button type="button" class="btn btn-danger btn-circle" style="margin-left:4px;"><i class="fa fa-times"></i>
                            </button>   
</a>
